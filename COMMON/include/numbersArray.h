struct shyriiwookNum numbersArray[] ={ { "aohwawh",         sizeof("aohwawh") - 1,         0},
                                       { "ah",              sizeof("ah") - 1,              1},
                                       { "ah-ah",           sizeof("ah-ah") - 1,           2},
                                       { "a-oo-ah",         sizeof("a-oo-ah") - 1,         3},
                                       { "wyoorg",          sizeof("wyoorg") - 1,          4},
                                       { "ah-wyoorg",       sizeof("ah-wyoorg") - 1,       5},
